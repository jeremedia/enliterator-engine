...
# to terms_for when nothing is approved; merges approved-key extensions otherwise.
RSpec.describe Enliterator::Vocabulary do
  ...
  it "returns exactly terms_for when nothing is approved (incl. nil for unconstrained)" do
  ...
  it "defaults the description when the term has no rationale" do
    Enliterator::Suggestion.create!(tendable: w, facet: "summary", proposed_key: "case_studies", rationale: "r", status: "approved")
  ...
  it "lets code-defined keys win on a name conflict" do
    Enliterator::Suggestion.create!(tendable: w, facet: "summary", proposed_key: "summary", rationale: "r", status: "approved")
  ...
  it "only counts APPROVED suggestions (pending/mapped/rejected don't extend the contract)" do
    Enliterator::Suggestion.create!(tendable: w, facet: "summary", proposed_key: "pending_k", rationale: "r", status: "pending")
